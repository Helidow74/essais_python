...
while len(list_of_friends) != len(list_of_amounts):
    ...
    total_spent = sum([amount for _, amount in friends])  # "_" spécifie qu'on ne veut que le deuxième item du tuple
    # on utilise "sum()" pour additionner toutes les valeurs de la liste
